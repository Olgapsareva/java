...
public class BaseAuthorizationService implements AuthorizationService {
    ...
    private final String URL = "jdbc:sqlite://C:\\Users\\opsar\\Desktop\\geekbrains\\java\\maven\\src\\main\\java\\Server\\users.db";
    ...
    @Override
    public void start() {
        Server.LOGGER.info("сервис авторизации запущен");
    }

    @Override
    public void stop() {
        Server.LOGGER.info("сервис авторизации остановлен");
    }
